...
COCO_DIR = os.path.expanduser('../../Code/cleanGCN/smsg_v2/datasets/coco')
...
parser.add_argument('--mask_learning_rate', default=0, type=float) #cm Azade, 1e-5

# Dataset options
parser.add_argument('--image_size', default='64,64', type=int_tuple) #cm Azade, 128,128
...
parser.add_argument('--dataset', default='vg', choices=['vg', 'coco', 'clevr'])
...
parser.add_argument('--use_attributes', default=False, type=bool_flag) #cm Azade, was True
...
parser.add_argument('--d_mask_weight', default=0, type=float) # 1.0 , Azade
parser.add_argument('--d_mask_features_weight', default=0, type=float) # 10.0 , Azade
...
log_dir = os.path.join(os.getcwd(), 'output', "Nov12_14-43-14_atnavab21") #current_time + '_' + socket.gethostname())
parser.add_argument('--print_every', default=100, type=int)
parser.add_argument('--checkpoint_every', default=2000, type=int)
